...
namespace BalartroLike.Run
{
    public static class ResourcesRunConfigLoader
    {
        ...
        public static void LoadIfNeeded()
        {
            ...
            if (nodeAsset == null || encounterAsset == null || realmAsset == null || shopOfferAsset == null || eventOptionAsset == null)
            {
                throw new InvalidOperationException("Missing run config resource.");
            }

            CsvRunConfigLoader.Load(nodeAsset.text, encounterAsset.text, realmAsset.text);
